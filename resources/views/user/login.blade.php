		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<h2>فرم ورود</h2>
					<form class="form-horizontal" action="{{url('userHotel/dashboard')}}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="user_email" id="user_email" type="text" placeholder=" نام کاربری یا ایمیل"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="user_password" id="user_password" type="password" placeholder="رمز"/>
							</div>
							<div class="clearfix"></div>
