...
@section('admin_area')
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="{{URL::to('/okAdminShod/slider/add')}}">افزودن اسلایدر</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{URL::to('/okAdminShod/slider/save')}}" method="POST"  enctype="multipart/form-data">
							{{csrf_field()}}
						  <fieldset>
