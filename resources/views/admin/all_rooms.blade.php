...
@section('admin_area')
		...
		<ul class="breadcrumb">
				...
				<li><a href="{{URL::to('/okAdminShod/room/all')}}">همه ی اتاق ها</a></li>
			</ul>
						 <?php 
						  ...
						  @php($i=0)
						  	@foreach($all_hotels as $hotel)
								...
								<td class="center">
									...
									<a class="btn btn-unsuccess" title="  تغییر وضعیت به حالت  غیرفعال" href="{{URL::to('/okAdminShod/room/'.$hotel->hotel_id.'/unactive')}}">
									...
									<a class="btn btn-info" title="ویرایش" href="{{URL::to('/okAdminShod/room/'.$hotel->hotel_id.'/edit')}}">
