			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{URL::to('/okAdminShod/room/'.$hotel->hotel_id.'/edit/done')}}" method="POST" enctype="multipart/form-data" id="myform">
							{{csrf_field()}}
						  <fieldset>
                                                             ...
                                                             @if($price->room_id == $room->room_id)
                                                                 @php($j=$j+1)
                                                                    ...
                                                                    <div class="row row_price" >
                                                                        <div class="col-xs-4"><label>از تاریخ</label><input type="text" class="date datepicker"  name="room_fromDate[{{$i}}][{{$j}}]" value="{{$price->room_fromDate}}"/></div>
                                                                        <div class="col-xs-4"><label>تا تاریخ</label><input type="text" class="date datepicker"  name="room_toDate[{{$i}}][{{$j}}]" value="{{$price->room_toDate}}" /></div>
