...
@section('admin_area')
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="{{URL::to('/okAdminShod/add_order')}}">بروزرسانی سفارش </a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						...
						{{
							URL::to(
								'/okAdminShod/order/'.$order_infos->order_id.'/edit/done'
							)
						}}
							" method="POST" >
							{{csrf_field()}}
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="hotel_id" name="hotel_id" data-rel="chosen" required>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="order_price" name="order_inDate" required value="{{$order_infos->order_inDate}}">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="order_price">تاریخ خروج <span>*</span> </label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="order_price" name="order_outDate" required value="{{$order_infos->order_outDate}}">
								</div>
							</div>
							<div class="control-group">
							...
							<div class="form-actions">
							  ...
							  <a href="{{URL::to('/okAdminShod/order/all')}}" class="btn">انصراف</a>
							</div>
						  </fieldset>
						</form>   
