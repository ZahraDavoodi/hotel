...
@section('admin_area')
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="{{URL::to('/okAdminShod/coupon/edit/'.$coupon_infos->coupon_id.'')}}">بروزرسانی </a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>به روز رسانی کد تخفیف</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						...
						{{
							URL::to(
								'/okAdminShod/coupon/'.$coupon_infos->coupon_id.'/edit/done'
							)
						}}
							...
							{{csrf_field()}}
							 <fieldset>
						  	...
						  	<div class="control-group">
								...
								<div class="controls">
								  <input type="text" name="coupon_code" id="coupon_code" value="{{$coupon_infos->coupon_code}}" required>
								</div>
							</div>
								<div class="control-group">
								<label class="control-label" for="coupon_title">توضیح <span>*</span> </label>
								<div class="controls">
								  <input type="text" name="coupon_description" id="coupon_description" value="{{$coupon_infos->coupon_description}}" required>
								</div>
							</div>
						  	...
						  	<div class="control-group">
								...
								<div class="controls">
								  <input type="number" name="coupon_price" id="coupon_price" value="{{$coupon_infos->coupon_price}}" required>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="text" name="coupon_start_date" class="date" id="coupon_start_date" value="{{$coupon_infos->coupon_start_date}}" required>
								</div>
							</div>
								...
								<div class="controls">
								  <input type="text" name="coupon_end_date" class="date" id="coupon_end_date" value="{{$coupon_infos->coupon_end_date}}" required>
								</div>
							</div>
											...
											<select name="hotel_id[]" data-rel="chosen" multiple>
												...
												@foreach($all_hotels as $hotel)
													@if($hotel->publication_status)
													  ...
													  @if(in_array($hotel->hotel_id,$selected_hotels))
