...
(function ($) {
    ...
    var preparePageMenus = function (current_page, pages, element) {
        ...
        menuHtml = '<li class="' + rpmListClass + ' prev ' + (current_page === fp ? 'disabled' : '') + '"><a class="' + rpmAnchorClass + '" href="#">قبلی</a></li>';
        ...
        menuHtml += '<li class="' + rpmListClass + ' next ' + (current_page === lp ? 'disabled' : '') + '"><a class="' + rpmAnchorClass + '" href="#">بعدی</a></li>';
