...
(function () {
    $.fn.persianDatepicker = function (t) {
        var i = "persianDatepicker", r = this.data(i);
    ...
    var n = function () {
        function n(n, t) {
            ...
            }, i.onresize = e, $(window).resize(e), $("body").append(i.calendar), i.render(), e()
        }
        ...
        return n.prototype = {
            show: function () {
                ...
                var n = this, f, e, r, h;
                _monthYear = $('<div class="" />'), _monthYear.appendTo(this.calendar), _head = $('<div class="header" ' + n.headerStyle + " />"), _head.appendTo(this.calendar), _next = $('<div class="nextArrow" />').html(this.options.nextArrow).attr("title", "ماه بعد"), n.options.endDate == null || n.persianDate.parse(n.options.endDate).year > n.persianDate.year || n.persianDate.parse(n.options.endDate).month > n.persianDate.month ? (_next.bind("click", function () {
                    for (nextMonth = n.persianDate.month + 1; n.options.selectableMonths._indexOf(nextMonth) == -1 && nextMonth < 13; nextMonth++);
                    n.persianDate.addMonth(nextMonth - n.persianDate.month), n.render()
                }), _next.removeClass("disabled")) : _next.addClass("disabled"), _next.appendTo(_head);
                var u = $('<ul class="monthSelect" ' + n.selectUlStyle + " />").hide(), t = $('<ul class="yearSelect" ' + n.selectUlStyle + " />").hide(), o = $("<span/>").html(n.options.months[n.persianDate.month - 1]).mousedown(function () {
                    return !1
                }).click(function (n) {
                    n.stopPropagation(), t.css({display: "none"}), u.css({display: "inline-block"})
                }), s = $("<span/>").html(n.options.persianNumbers ? n.jDateFunctions.toPersianNums(n.persianDate.year) : n.persianDate.year).mousedown(function () {
                    return !1
                }).click(function (n) {
                    n.stopPropagation(), u.css({display: "none"}), t.css({display: "inline-block"}), t.scrollTop(70)
                });
                for (_startDate = n.options.startDate != null ? n.persianDate.parse(n.options.startDate) : n.persianDate.parse("1/1/1"), _endDate = n.options.endDate != null ? n.persianDate.parse(n.options.endDate) : n.persianDate.parse("9999/1/1"), f = function (r, u) {
                    var f = !1, e;
                    for (r === undefined && u === undefined ? (b = n.persianDate.year - 7, a = n.persianDate.year + 14) : u == 0 ? (b = r - 6, a = r, f = !0) : r == 0 && (b = u + 1, a = b + 6), e = [], i = b; i < a && b > 0; i++)e.push(parseInt(i));
                    $.each(n.options.selectableYears || (f ? e.reverse() : e), function (i, r) {
                        var u = $("<li " + n.selectYearLiStyle + " />").html(n.options.persianNumbers ? n.jDateFunctions.toPersianNums(r) : r);
                        r == n.persianDate.year && u.addClass("selected"), u.attr("value", r), u.bind("click", function () {
                            n.persianDate.date = 1, n.persianDate.year = parseInt(r), (_endDate.year == r || _endDate.year == 9999) && (n.persianDate.month = _endDate.month), (_startDate.year == r || _startDate.year == 9999) && (n.persianDate.month = _startDate.month), n.render()
                        }), f ? t.prepend(u) : t.append(u)
                    })
                }, f(), i = 1; i <= 12; i++)e = n.options.months[i - 1], r = n.options.selectableMonths._indexOf(i) == -1 || _startDate.year == n.persianDate.year && _startDate.month > i || _endDate.year == n.persianDate.year && i > _endDate.month ? $('<li class="disableMonth" ' + n.selectMonthLiStyle + " />").html(e) : $("<li " + n.selectMonthLiStyle + " />").html(e), i == n.persianDate.month && r.addClass("selected"), r.data("month", {
                    month: e,
                    monthNum: i
                }), r.hasClass("disableMonth") || r.bind("click", function () {
                    n.persianDate.date = 1, n.persianDate.month = $(this).data("month").monthNum, n.render()
                }), u.append(r);
                ...
                }), _monthYear.append(u).append(t), h = $('<div class="monthYear" />').append(o).append("<span>&nbsp;&nbsp;<\/span>").append(s), _head.append(h), _prev = $('<div class="prevArrow" />').html(this.options.prevArrow).attr("title", "ماه قبل"), n.options.startDate == null || n.persianDate.parse(n.options.startDate).year < n.persianDate.year || n.persianDate.parse(n.options.startDate).month < n.persianDate.month ? (_prev.bind("click", function () {
                    for (prevMonth = n.persianDate.month - 1; n.options.selectableMonths._indexOf(prevMonth) == -1 && prevMonth > 0; prevMonth--);
                    n.persianDate.addMonth(-(n.persianDate.month - prevMonth)), n.render()
                ...
                for (_days = $('<div class="days" />'), _days.appendTo(this.calendar), jd = n.persianDate, jd.date = 1, _start = n.jDateFunctions.getWeekday(n.jDateFunctions.getJulianDayFromPersian(jd)), _end = n.jDateFunctions.getLastDayOfPersianMonth(n.persianDate), r = 0, t = 0; r < 6; r++) {
                    for (_row = $("<div />"), i = 0; i < 7; i++, t++)t < _start || t - _start + 1 > _end ? _cell = $('<div class="nul cell " ' + n.cellStyle + " />").html("&nbsp;") : (_dt = n.getDate(n.persianDate, t - _start + 1), _today = "", _selday = "", _disday = "", n.now().compare(_dt) == 0 && (_today = "today"), n.options.startDate != null && (n.persianDate.parse(n.options.startDate).compare(_dt) == -1 || n.persianDate.parse(n.options.endDate).compare(_dt) == 1) && (_disday = "disday"), n.options.selectedDate != undefined ? n.persianDate.parse(n.options.selectedDate).date == t - _start + 1 && (_selday = "selday") : t - _start + 1 == n.now().date && (_selday = "selday"), _fri = i == 6 ? "friday" : "", _cell = $('<div class="day cell ' + _fri + " " + _today + " " + _selday + " " + _disday + '" ' + n.cellStyle + " />"), _cell.data("date", {
                        jDate: _dt.toString("YYYY/MM/DD/DW"),
                        gDate: n.jDateFunctions.getGDate(_dt)._toString(n.options.formatDate)
                    }), _cell.html(n.options.persianNumbers ? n.jDateFunctions.toPersianNums(t - _start + 1) : t - _start + 1), (n.options.startDate == undefined || n.persianDate.parse(n.options.startDate).compare(_dt) != -1 && n.persianDate.parse(n.options.endDate).compare(_dt) != 1) && _cell.bind("click", function () {
                ...
                var n = this;
                _footer = $('<div class="footer" ' + n.footerStyle + " />"), _footer.appendTo(this.calendar), n.options.selectableMonths._indexOf(n.persianDate.month) > -1 && (_goToday = $('<a class="goToday" />'), _goToday.data("date", {
                    jDate: n.now().toString("YYYY/MM/DD/DW"),
                    gDate: n.jDateFunctions.getGDate(n.now())._toString(n.options.formatDate)
                }), _goToday.attr("href", "javascript:;").html("هم اکنون"), n.options.startDate == null && _goToday.bind("click", function () {
                    n.persianDate = n.now(), n.options.showGregorianDate ? n.showDate(n.el, $(this).data("date").gDate) : n.showDate(n.el, $(this).data("date").jDate), n.calendar.find(".day").removeClass("selday"), n.render(), n.calendar.find(".today").addClass("selday"), n.hide()
                }), _goToday.appendTo(_footer))
            }, showDate: function (n, t) {
                var i = this;
                n.is("input") ? n.val(i.persianDate.parse(t).toString(i.options.formatDate)) : n.html(i.persianDate.parse(t).toString(i.options.formatDate)), n.data("date", {
                    jDate: t,
    ...
    (function () {
        Number.prototype.padLeft = function (n, t) {
            ...
            return (months = ["Januray", "February", "March", "April", "May", "June", "Julay", "August", "September", "October", "November", "December"], dows = ["Sun", "Mon", "Tue", "Wed", "Tur", "Fri", "Sat"], n === undefined || n == "default") ? this : n.replace("YYYY", this.getFullYear()).replace("MM", this.getMonth() + 1).replace("DD", this.getDate()).replace("0M", this.getMonth() + 1 > 9 ? this.getMonth() + 1 : "0" + (this.getMonth() + 1)).replace("0D", this.getDate() > 9 ? this.getDate() : "0" + this.getDate()).replace("hh", this.getHours()).replace("mm", this.getMinutes()).replace("ss", this.getSeconds()).replace("ms", this.getMilliseconds()).replace("tm", this.getHours() >= 12 && this.getMinutes() > 0 ? "PM" : "AM").replace("NM", months[this.getMonth()]).replace("DW", this.getDay()).replace("ND", dows[this.getDay()])
...
var persianDate = function () {
    function n() {
        var n = this;
        n.months = ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"], n.dowTitle = ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه"], n.year = 1300, n.month = 1, n.date = 1, n.day = 1, n.gDate = new Date
    }
    ...
    return n.prototype = {
        addMonth: function (n) {
            ...
            arr = t.split("/"), y = arr[0], m = arr[1], d = arr[2], wd = arr[3];
            var i = new n;
    ...
    return n.prototype = {
        toPersianNums: function (n) {
            ...
            var r = 0, u = 0, h = 0, a, p, s, i;
            if (n > 0) {
                var c = n + .5, v = Math.floor(c), w = c - v, f = Math.floor(n) + .5, t = new persianDate;
                t.year = 475, t.month = 1, t.date = 1;
                var l = f - this.getJulianDayFromPersian(t), y = Math.floor(l / 1029983), e = l % 1029983, o;
                e == 1029982 ? o = 2820 : (a = Math.floor(e / 366), p = e % 366, o = Math.floor((2134 * a + 2816 * p + 2815) / 1028522) + a + 1), r = o + 2820 * y + 474, r <= 0 && r--, t.year = r, t.month = 1, t.date = 1, s = f - this.getJulianDayFromPersian(t) + 1, u = s <= 186 ? Math.ceil(s / 31) : Math.ceil((s - 6) / 30), t.year = r, t.month = u, t.date = 1, h = f - this.getJulianDayFromPersian(t) + 1
            }
            return i = new persianDate, i.year = r, i.month = u, i.date = h, i.day = this.getWeekday(this.getJulianDayFromPersian(i)), i.gDate = new Date, i
        }, getGCalendarDate: function (n, t) {
            var e = 0, i = 0, c = 0, a;
            if (n > 0) {
                var l = n + .5, u = Math.floor(l), y = l - u, o;
                t == "jmonth" || t == "jgmonth" && u < 2299161 ? o = u : (t == "gmonth" || t == "jgmonth" && u >= 2299161) && (a = Math.floor((u - 1867216.25) / 36524.25), o = u + 1 + a - Math.floor(a / 4));
                var s = o + 1524, h = Math.floor((s - 122.1) / 365.25), v = Math.floor(365.25 * h), f = Math.floor((s - v) / 30.6001);
                c = s - v - Math.floor(30.6001 * f) + y, f < 14 ? i = f - 1 : (f == 14 || f == 15) && (i = f - 13), i > 2 ? e = h - 4716 : (i == 1 || i == 2) && (e = h - 4715)
            }
            return r = new Date, new Date(e, i - 1, c, r.getHours(), r.getMinutes(), r.getSeconds(), r.getMilliseconds())
        }, getJulianDay: function (n, t) {
            var t = t === undefined ? 0 : t, r = n.getFullYear(), i = n.getMonth() + 1, u = n.getDate(), f = r + 0, e = i + 0, n = u + 0, o, s, h;
            ...
            y0 = n.year, m0 = n.month, d0 = n.date;
